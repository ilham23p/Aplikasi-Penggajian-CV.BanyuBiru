                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="user-data m-b-30">
                                                <h3 class="title-3 m-b-30">
                                                    <i class="fas fa-chart-bar"></i>User <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#largemodal"><i class="zmdi zmdi-plus"></i>tambah</a></h3>
                                                            ...
                                                            <div class="modal fade" id="largemodal{!!$row->id!!}" tabindex="-1" role="dialog" aria-labelledby="largemodalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        {!! Form::model($row, ['route' => ['users.update', $row->id], 'method'=>'patch', 'id'=>'update'.$row->id, 'files' => true]) !!}
                                                             ...
                                                             data-backdrop="static">
                                                                <div class="modal-dialog modal-sm" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            {!! Form::open(['route'=>['users.destroy', $row->id], 'method'=>'delete', 'id'=>'hapus'.$row->id]) !!}
            ...
            <div class="modal fade" id="largemodal" tabindex="-1" role="dialog" aria-labelledby="largemodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                        {!! Form::open(['route' => 'users.store', 'method'=>'POST', 'id'=>'store', 'files' => true]) !!}
                            @include('admin.user.form')
                        {!! Form::close() !!}
                        </div>
                        <div class="modal-footer">
